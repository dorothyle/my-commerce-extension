...
exports.TOOL_PERMISSION = exports.TOOLS_CHANGE_EVENT = void 0;
/**
...
var TOOL_PERMISSION;
(function (TOOL_PERMISSION) {
    /** Automatically execute this tool */
    TOOL_PERMISSION["ALLOW"] = "ALLOW";
    /** Always prompt the user before executing the tool */
    TOOL_PERMISSION["ASK"] = "ASK";
    /**
     * Always prompt the user before executing the tool,
     * but additionally give them the option for "always allow"
     * which will remember their choice for the session.
     */
    TOOL_PERMISSION["ASK_REMEMBER"] = "ASK_REMEMBER";
})(TOOL_PERMISSION || (exports.TOOL_PERMISSION = TOOL_PERMISSION = {}));
const webmcp = {
    executeTool: (name, parameters, options) => {
        return (0, Global_1.getImpl)('webmcp')().executeTool(name, parameters, options);
    },
    getTools: () => {
